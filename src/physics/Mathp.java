...
public class Mathp {
	...
	public static final float DT = 1.0f / Window.FPS;
	public static final Vector2f GRAVITY = new Vector2f(0.0f, -50.0f);
	public static final float RESTING = GRAVITY.multiply(DT).magnitudeSq() + EPSILON;
